...
\begin{longenum}[ label*=\arabic*., align=left]
\item  advocate on concerns or issues affecting graduate students constituency group members at Western;
...
\item  foster a sense of community and build relations within the constituency group and in the campus community;
...
\end{longenum}
\item Commissioners shall report to Council at a minimum of \underline{twice per academic term} (Fall, Winter, Summer) and bring forward issues from the constituency to Council and the Executive as appropriate for action.
\index{Reports!Commissioner Constituency Meeting}
\item Commissioners who fail to call (to try to hold) constituency meetings at least once per term are subject to recall procedures.
