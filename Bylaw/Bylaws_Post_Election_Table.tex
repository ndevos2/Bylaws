...
\subsection{Duties of the Chairperson}\label{chair: duties}
...
\begin{longenum}[ label*=\thesubsection.\arabic*., align=left]
    ...
    \item submit to Council a list of members appointed to the committee and removed from the committee since the previous Council meeting. \label{chair: member nomination}
...
\begin{longenum}[ label*=\thesubsection.\arabic*., align=left]
    ...
    \item Each Committee shall have an Official Liaison, who shall be \replace{either an Executive member or the Speaker}{an Officer}\astfootnote of the Society.\label{committee: has OL}\index{Committee!Official Liaison}
    \item The Official Liaison shall be considered an ex-officio, non-voting member of the committee.\label{committee: OL ex-officio}\index{Committee!Official Liaison!Ex-Officio}
    \item In any committee of the Society with a composition not exceeding three (3) members, all voting members must be present in person for business to be transacted.\index{Committee!Quorum}\index{Quorum!Committee!Less than 3 Members}
    \item In any committee of the Society with a composition exceeding 3 members, a majority of one--half plus one must be present in person or by proxy for business to be transacted. \label{committee: quorum}
        \index{Quorum!Committee!More than 3 Members}
    \item All business transacted in the absence of quorum is null and void. 
    \item For the purposes of determining quorum, membership of any committee of the Society shall constitute only those members who are currently present or who have attended at least one meeting of the same committee in the past.\label{committee: quorum attendance req}
...
\begin{longenum}[ label*=\thesubsection.\arabic*., align=left]
    ...
    \begin{longenum}[ label*=\arabic*., align=left]
        ...
        \item Limit membership to a specific number.\label{committee:cap}
...
\subsubsection[Subsidies Committee]{The {\replace{Bursary and Subsidy Committee (BSC)}{Subsidies Committee}}\protect\astfootnote}\label{committee: bsc}
\begin{longenum}[ label*=\thesubsubsection.\arabic*., align=left]
	\item shall have a Chair;
    \item shall, whenever possible, assist in collecting and organizing data on overall student support; 
        \index{Committee!Bursary and Subsidy Committee!Mandate}
    \item shall assist the Vice-President Finance in administering \remove{the Society, Grad Club and external}\astfootnote bursaries and subsidies \add{overseen by the Society, including from the Society, Grad Club, and external sources bursaries and subsidies}\astref;
...
\subsubsection{The International Graduate Students' Issues Committee (IGSIC)} \label{committee: IGSIC}
\begin{longenum}[ label*=\thesubsubsection.\arabic*., align=left]
...
\index{Commission}
\subsubsection{General}\label{sec: commissions}
\begin{longenum}[ label*=\thesubsubsection.\arabic*., align=left]
	\item Commissions are committees with the following exceptions:
    \begin{longenum}[ label*=\arabic*., align=left]
		\item \add{Notwithstanding Bylaw \ref{committee: has OL},}\astfootnote the chairperson is the Official Liaison to Council, unless otherwise specified in this (\ref{sec: commissions}) section.
	\end{longenum}
\end{longenum}
\subsubsection {\replace{Women's}{Gender}\protect\astfootnote Concern Commission}
\index{Women's Consern Commission!Mandate}
\index{Commission!Women's Consern Commission!Mandate}
\begin{longenum}[ label*=\thesubsubsection.\arabic*., align=left]
	\item \add{shall be chaired by the Gender Concerns Commissioner;}\astfootnote
	\item shall discuss and make recommendations to Council on issues affecting \remove{graduate students who are}\astfootnote constituency members;
    \item shall serve as a liaison between the Society and other groups and programs \replace{concerned with issues of concern to women}{relevant to the concerns of gender, sexuality, and sexual violence}\astfootnote on campus and in the community;
    \item shall work to increase awareness of issues affecting \replace{women and transgendered people}{gender, sexuality, and sexual violence}\astfootnote on campus, particularly within the graduate student community, through events and publicity campaigns.
    \index{Women's Concern Commission!Membership}
\index{Commission!Women's Concern Commission!Membership}
    \item Members of the Commission \replace{must}{shall}\astfootnote be graduate students who \replace{are women and/or individuals who identify as transgender}{identify as having gender concerns}\astfootnote.
\end{longenum}
\add{\subsubsection{Accessibility Commission \protect\astfootnote}
\index{Accessibility Commission!Mandate}
\index{Commission!Accessibility Commission!Mandate}
\begin{longenum}[ label*=\thesubsubsection.\arabic*., align=left]
	\item shall be chaired by the Accessibility Commissioner;
	\item shall discuss and make recommendations to Council on issues affecting constituency members;
	\item shall serve as a liaison between the Society and other groups and programs relevant to accessibility on campus and in the community;
	\item shall work to increase awareness of issues affecting accessibility on campus, particularly within the graduate student community, through events and publicity campaigns;
	\item Members of the Commission shall be graduate students who identify as having a disability or who identify as an ally to the disability community. 
\end{longenum}}
\add{\subsubsection{Pride Commission \protect\astfootnote}
\index{Pride Commission!Mandate}
\index{Commission!Pride Commission!Mandate}
\begin{longenum}[ label*=\thesubsubsection.\arabic*., align=left]
	\item shall be chaired by the Pride Commissioner;
	\item shall discuss and make recommendations to Council on issues affecting constituency members;
	\item shall serve as a liaison between the Society and other groups and programs relevant to Pride and the concerns of LGBTQIA2S+ people on campus and in the community;
	\item shall work to increase awareness of issues affecting LGBTQIA2S+ people on campus, particularly within the graduate student community, through events and publicity campaigns;
	\item Members of the Commission shall be graduate students who identify as a member of the LGBTQIA2S+ community or who identify as an ally to the LGBTQIA2S+ community, with a minimum of two seats reserved for self-identified members of the LGBTQIA2S+ community.  
\end{longenum}}
\add{\subsubsection{Racial Equity \& Inclusivity Commission \protect\astfootnote}
\index{Racial Equity \& Inclusivity Commission!Mandate}
\index{Commission!Racial Equity \& Inclusivity Commission!Mandate}
\begin{longenum}[ label*=\thesubsubsection.\arabic*., align=left]
	\item shall be chaired by the Racial Equity \& Inclusivity Commissioner;
	\item shall discuss and make recommendations to Council on issues affecting constituency members;
	\item shall serve as a liaison between the Society and other groups and programs relevant to the concerns of racialized people on campus and in the community.
	\item shall work to increase awareness of issues affecting racial equity and inclusivity on campus, particularly within the graduate student community, through events and publicity campaigns;
	\item Members of the Commission shall be racially diverse graduate students.
\end{longenum}}
...
\index{Executive, The!Official Liaison Table}
    ...
    Bylaws and Constitution & Speaker \\
    \remove{Bursaries and}\asttablefootnote  Subsidies & VP Finance \\ 
    Equity & VP Advocacy \\ 
    Finance & VP Finance  \\ 
    ...
    International Graduate Students' Issues &  VP Advocacy \\ 
