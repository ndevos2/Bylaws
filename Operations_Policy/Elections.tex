...
\begin{longenum}[ label*=\thesection.\arabic*., align=left]
 ...
 \begin{longenum}[label*=\arabic*., align=left]
  ...
  \item Appeals regarding sanctions or disqualifications levied by the Chief Returning Officer shall be made in writing to the Appeals Review Commission, care of the Society's office, within forty-eight (48) hours of the announcement. The Appeals Review Commission shall render a decision and make such decision within two (2) days following their meeting.
  \end{longenum}

 \item \textbf{Presidential Nominations}
 \begin{longenum}[label*=\arabic*., align=left]
  \item  Nominations for the position of President shall be \replace{open from the first Monday following January 2nd}{opened at a date determined by the CRO}\astfootnote for ten (10) consecutive business days \add{and at least twenty (20) business days prior to a balloting date set by the University Secretariat}\astref, closing on the tenth day at the close of business hours. 
  ...
  \item In the event that no nominations for the position of President be received by the Chief Returning Officer by the close of nominations, nominations shall be reopened \replace{the first Monday in February and close after ten (10) consecutive business days}{immediately following the closure of the first nomination period and re-close after five (5) consecutive business days}\astfootnote, at the close of business hours.\label{pres election: second nom}
...
\item The campaign period shall begin \replace{two business days}{one (1) business day}\astfootnote after nominations close and shall continue up to and including the day preceding the balloting. No campaigning may be undertaken other than during the designated campaign period.
...
\item Voting
	...
	\item A secret ballot shall be held following the close of the campaign period, for the Presidential election, or during a period determined by Council, for a referendum.
		...
		\item In the event that a \remove{second nomination period is required for the}\astfootnote Presidential election (see \ref{pres election: second nom}) \replace{and nominations are received by the CRO during that second nomination period}{will occur outside the timeline set by the University Secretariat and/or the timeline as described above}\astref, the following protocols shall be followed:
			\begin{longenum}[label*=\arabic*., align=left]
			\item On-line polling shall be conducted by the CRO, with assistance from the DCRO;
			\item The polling period shall be determined by the CRO, in accordance with 2.4.7.2. \remove{The polling period shall take place no later than the third full week of March}\astfootnote;
...
\item Counting Ballots
	...
	\item A plurality of ballots cast will determine the results of any referendum or election \add{with two or fewer options}\astfootnote.
	\add{\item An instant-runoff voting system will determine the results of any referendum or election with three or more options.}\astfootnote
