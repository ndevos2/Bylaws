...
\subsection{Leave-of-Absence Membership}
\index{Membership!Leave-of-Absence Membership}
	\begin{longenum}[label*=\thesubsection.\arabic*., align=left]
...
\subsection{Non-Executive Officers}
	...
	\begin{longenum}[label*=\thesubsection.\arabic*., align=left]
	\item The Non-Executive shall consist of the Speaker, the Deputy Speaker, the Commissioners, the Coordinators, the Ombudsperson, the Chief Returning Officer, and the Deputy Chief Returning Officer. 
...
\end{longenum}
\subsection{Term Limits for Committees}
    \index{Committee!Term Limit}
	\begin{longenum}[label*=\thesubsection.\arabic*., align=left]
	\item No member of a committee may serve more than 12 consecutive months without being ratified for a new year by Council.\label{committee:term limit}
\end{longenum}
\newpage
