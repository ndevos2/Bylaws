...
\begin{longenum}[ label*=\thesubsection.\arabic*., align=left] 
	...
	\item Roles and responsibilities:
		...
		\item The Chairperson(s) shall:
			...
			\item Oversee the administration and moderation of the SOGS Virtual Grad Space Discord Server.					\item Endeavour to adjudicate, with the Committee, Social Fund and board game applications in a timely manner.
