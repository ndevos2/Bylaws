...
\item Executive members of the Society shall be compensated in proportion to TA wages, as follows: \replace{1.0}{0.5}\ssfootnote\crosscontent TA for Vice-President and \replace{1.5}{1.0}\ssref   TA for the President.
...
\add{\item Committees are strongly encouraged to use an instant-runoff voting system (ranked ballot) for all elections or votes that have three (3) or more options.}\astfootnote
\end{longenum}
